...
const DEFAULT_SECTIONS = [
  {
    ...
    content: [
      'We offer two shipping options: India Post and Delhivery.',
      'India Post: Free shipping on all orders above \u20B93,000. A flat charge of \u20B975 applies to orders below \u20B93,000.',
      'Delhivery: Dynamic pricing calculated at checkout based on your delivery pincode. Offers faster 2\u20134 business day delivery.',
      'You can choose your preferred courier at checkout.',
  ...
  },
  {
    ...
    content: [
      ...
      'India Post orders can be tracked using the tracking number on the India Post website.',
      'Delhivery orders include live tracking \u2014 track your shipment in real time directly from your order details page.',
      ...
      <div style={{ background: '#FAF7F2' }}>
        ...
        <section className="relative pt-20 pb-12 md:pt-28 md:pb-16 px-4 overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center">
            ...
            >
              {content?.pageTitle || 'Shipping Policy'}
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 15 }}
              animate={{ opacity: 1, y: 0 }}
